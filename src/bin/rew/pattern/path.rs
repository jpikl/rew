...
mod tests {
    ...
    #[cfg_attr(window, test_case("file.ext",     "{work}\\file.ext"; "relative"))]
    ...
    #[cfg_attr(unix,   test_case("{work}/../file.ext",   "../file.ext";  "absolute"))]
    #[cfg_attr(window, test_case("file.ext",             "file.ext";     "relative"))]
    #[cfg_attr(window, test_case("{work}\\..\\file.ext", "..\\file.ext"; "absolute"))]
    ...
    mod canonicalize {
        ...
        #[cfg_attr(unix,    test_case("src/",  "{work}/src";  "relative"))]
        #[cfg_attr(windows, test_case("C:",    "C:\\";        "prefix"))]
        #[cfg_attr(windows, test_case("C:\\",  "C:\\";        "root"))]
        #[cfg_attr(windows, test_case("src\\", "{work}\\src"; "relative"))]
    ...
    #[                  test_case("",                      ".";        "empty")]
    #[                  test_case("a",                     "a";        "relative separator 1")]
    #[cfg_attr(unix,    test_case("a/",                    "a";        "relative separator 2"))]
    #[cfg_attr(unix,    test_case("a/b",                   "a/b";      "relative separator 3"))]
    #[cfg_attr(unix,    test_case("a/b/",                  "a/b";      "relative separator 4"))]
    #[cfg_attr(unix,    test_case("a//",                   "a";        "relative separator 5"))]
    #[cfg_attr(unix,    test_case("a//b",                  "a/b";      "relative separator 6"))]
    #[cfg_attr(unix,    test_case("a//b//",                "a/b";      "relative separator 7"))]
    #[cfg_attr(windows, test_case("a\\",                   "a";        "relative separator 2"))]
    #[cfg_attr(windows, test_case("a\\b",                  "a\\b";     "relative separator 3"))]
    #[cfg_attr(windows, test_case("a\\b\\",                "a\\b";     "relative separator 4"))]
    #[cfg_attr(windows, test_case("a\\\\",                 "a";        "relative separator 5"))]
    #[cfg_attr(windows, test_case("a\\\\b",                "a\\b";     "relative separator 6"))]
    #[cfg_attr(windows, test_case("a\\\\b\\\\",            "a\\b";     "relative separator 7"))]
    #[cfg_attr(windows, test_case("a/",                    "a";        "relative unix separator 1"))]
    #[cfg_attr(windows, test_case("a/b",                   "a\\b";     "relative unix separator 2"))]
    #[cfg_attr(windows, test_case("a/b/",                  "a\\b";     "relative unix separator 3"))]
    ...
    #[cfg_attr(unix,    test_case("./a",                   "a";        "relative dot 5"))]
    #[cfg_attr(unix,    test_case("./a/",                  "a";        "relative dot 6"))]
    #[cfg_attr(unix,    test_case("a/.",                   "a";        "relative dot 7"))]
    #[cfg_attr(unix,    test_case("a/./",                  "a";        "relative dot 8"))]
    ...
    #[cfg_attr(windows, test_case(".\\a",                  "a";        "relative dot 5"))]
    #[cfg_attr(windows, test_case(".\\a\\",                "a";        "relative dot 6"))]
    #[cfg_attr(windows, test_case("a\\.",                  "a";        "relative dot 7"))]
    #[cfg_attr(windows, test_case("a\\.\\",                "a";        "relative dot 8"))]
    ...
    #[cfg_attr(unix,    test_case("../a",                  "../a";     "relative double dot 5"))]
    #[cfg_attr(unix,    test_case("../a/",                 "../a";     "relative double dot 6"))]
    #[cfg_attr(unix,    test_case("a/..",                  ".";        "relative double dot 7"))]
    #[cfg_attr(unix,    test_case("a/../",                 ".";        "relative double dot 8"))]
    #[cfg_attr(unix,    test_case("a/../b",                "b";        "relative double dot 9"))]
    #[cfg_attr(unix,    test_case("a/../b/",               "b";        "relative double dot 10"))]
    #[cfg_attr(unix,    test_case("a/../b/c",              "b/c";      "relative double dot 11"))]
    #[cfg_attr(unix,    test_case("a/../b/c/",             "b/c";      "relative double dot 12"))]
    #[cfg_attr(unix,    test_case("a/../../c",             "../c";     "relative double dot 13"))]
    #[cfg_attr(unix,    test_case("a/../../c/",            "../c";     "relative double dot 14"))]
    #[cfg_attr(unix,    test_case("a/b/../../c",           "c";        "relative double dot 15"))]
    #[cfg_attr(unix,    test_case("a/b/../../c/",          "c";        "relative double dot 16"))]
    ...
    #[cfg_attr(windows, test_case("..\\a",                 "..\\a";    "relative double dot 5"))]
    #[cfg_attr(windows, test_case("..\\a\\",               "..\\a";    "relative double dot 6"))]
    #[cfg_attr(windows, test_case("a\\..",                 ".";        "relative double dot 7"))]
    #[cfg_attr(windows, test_case("a\\..\\",               ".";        "relative double dot 8"))]
    #[cfg_attr(windows, test_case("a\\..\\b",              "b";        "relative double dot 9"))]
    #[cfg_attr(windows, test_case("a\\..\\b\\",            "b";        "relative double dot 10"))]
    #[cfg_attr(windows, test_case("a\\..\\b\\c",           "b\\c";     "relative double dot 11"))]
    #[cfg_attr(windows, test_case("a\\..\\b\\c\\",         "b\\c";     "relative double dot 12"))]
    #[cfg_attr(windows, test_case("a\\..\\..\\c",          "..\\c";    "relative double dot 13"))]
    #[cfg_attr(windows, test_case("a\\..\\..\\c\\",        "..\\c";    "relative double dot 14"))]
    #[cfg_attr(windows, test_case("a\\b\\..\\..\\c",       "c";        "relative double dot 15"))]
    #[cfg_attr(windows, test_case("a\\b\\..\\..\\c\\",     "c";        "relative double dot 16"))]
    #[cfg_attr(unix,    test_case("/",                     "/";        "absolute separator 1"))]
    #[cfg_attr(unix,    test_case("/a",                    "/a";       "absolute separator 2"))]
    #[cfg_attr(unix,    test_case("/a/",                   "/a";       "absolute separator 3"))]
    #[cfg_attr(unix,    test_case("/a/b",                  "/a/b";     "absolute separator 4"))]
    #[cfg_attr(unix,    test_case("/a/b/",                 "/a/b";     "absolute separator 5"))]
    #[cfg_attr(unix,    test_case("//a",                   "/a";       "absolute separator 6"))]
    #[cfg_attr(unix,    test_case("//a//",                 "/a";       "absolute separator 7"))]
    #[cfg_attr(unix,    test_case("//a//b",                "/a/b";     "absolute separator 8"))]
    #[cfg_attr(unix,    test_case("//a//b//",              "/a/b";     "absolute separator 9"))]
    #[cfg_attr(windows, test_case("C:",                    "C:\\";     "absolute separator 0"))]
    #[cfg_attr(windows, test_case("C:\\",                  "C:\\";     "absolute separator 1"))]
    #[cfg_attr(windows, test_case("C:\\a",                 "C:\\a";    "absolute separator 2"))]
    #[cfg_attr(windows, test_case("C:\\a\\",               "C:\\a";    "absolute separator 3"))]
    #[cfg_attr(windows, test_case("C:\\a\\b",              "C:\\a\\b"; "absolute separator 4"))]
    #[cfg_attr(windows, test_case("C:\\a\\b\\",            "C:\\a\\b"; "absolute separator 5"))]
    #[cfg_attr(windows, test_case("C:\\\\a",               "C:\\a";    "absolute separator 6"))]
    #[cfg_attr(windows, test_case("C:\\\\a\\\\",           "C:\\a";    "absolute separator 7"))]
    #[cfg_attr(windows, test_case("C:\\\\a\\\\b",          "C:\\a\\b"; "absolute separator 8"))]
    #[cfg_attr(windows, test_case("C:\\\\a\\\\b\\\\",      "C:\\a\\b"; "absolute separator 9"))]
    #[cfg_attr(windows, test_case("C:/a",                  "C:\\a";    "absolute unix separator 1"))]
    #[cfg_attr(windows, test_case("C:/a/",                 "C:\\a";    "absolute unix separator 2"))]
    #[cfg_attr(windows, test_case("C:/a/b",                "C:\\a\\b"; "absolute unix separator 3"))]
    #[cfg_attr(windows, test_case("C:/a/b/",               "C:\\a\\b"; "absolute unix separator 4"))]
    ...
    #[cfg_attr(unix,    test_case("/./a",                  "/a";       "absolute dot 5"))]
    #[cfg_attr(unix,    test_case("/./a/",                 "/a";       "absolute dot 6"))]
    #[cfg_attr(unix,    test_case("/a/.",                  "/a";       "absolute dot 7"))]
    #[cfg_attr(unix,    test_case("/a/./",                 "/a";       "absolute dot 8"))]
    ...
    #[cfg_attr(windows, test_case("C:\\.\\a",              "C:\\a";    "absolute dot 5"))]
    #[cfg_attr(windows, test_case("C:\\.\\a\\",            "C:\\a";    "absolute dot 6"))]
    #[cfg_attr(windows, test_case("C:\\a\\.",              "C:\\a";    "absolute dot 7"))]
    #[cfg_attr(windows, test_case("C:\\a\\.\\",            "C:\\a";    "absolute dot 8"))]
    ...
    #[cfg_attr(unix,    test_case("/../a",                 "/a";       "absolute double dot 5"))]
    #[cfg_attr(unix,    test_case("/../a/",                "/a";       "absolute double dot 6"))]
    #[cfg_attr(unix,    test_case("/a/..",                 "/";        "absolute double dot 7"))]
    #[cfg_attr(unix,    test_case("/a/../",                "/";        "absolute double dot 8"))]
    #[cfg_attr(unix,    test_case("/a/../b",               "/b";       "absolute double dot 9"))]
    #[cfg_attr(unix,    test_case("/a/../b/",              "/b";       "absolute double dot 10"))]
    #[cfg_attr(unix,    test_case("/a/../b/c",             "/b/c";     "absolute double dot 11"))]
    #[cfg_attr(unix,    test_case("/a/../b/c/",            "/b/c";     "absolute double dot 12"))]
    #[cfg_attr(unix,    test_case("/a/../../c",            "/c";       "absolute double dot 13"))]
    #[cfg_attr(unix,    test_case("/a/../../c/",           "/c";       "absolute double dot 14"))]
    #[cfg_attr(unix,    test_case("/a/b/../../c",          "/c";       "absolute double dot 15"))]
    #[cfg_attr(unix,    test_case("/a/b/../../c/",         "/c";       "absolute double dot 16"))]
    ...
    #[cfg_attr(windows, test_case("C:\\..\\a",             "C:\\a";    "absolute double dot 5"))]
    #[cfg_attr(windows, test_case("C:\\..\\a\\",           "C:\\a";    "absolute double dot 6"))]
    #[cfg_attr(windows, test_case("C:\\a\\..",             "C:\\";     "absolute double dot 7"))]
    #[cfg_attr(windows, test_case("C:\\a\\..\\",           "C:\\";     "absolute double dot 8"))]
    #[cfg_attr(windows, test_case("C:\\a\\..\\b",          "C:\\b";    "absolute double dot 9"))]
    #[cfg_attr(windows, test_case("C:\\a\\..\\b\\",        "C:\\b";    "absolute double dot 10"))]
    #[cfg_attr(windows, test_case("C:\\a\\..\\b\\c",       "C:\\b\\c"; "absolute double dot 11"))]
    #[cfg_attr(windows, test_case("C:\\a\\..\\b\\c\\",     "C:\\b\\c"; "absolute double dot 12"))]
    #[cfg_attr(windows, test_case("C:\\a\\..\\..\\c",      "C:\\c";    "absolute double dot 13"))]
    #[cfg_attr(windows, test_case("C:\\a\\..\\..\\c\\",    "C:\\c";    "absolute double dot 14"))]
    #[cfg_attr(windows, test_case("C:\\a\\b\\..\\..\\c",   "C:\\c";    "absolute double dot 15"))]
    #[cfg_attr(windows, test_case("C:\\a\\b\\..\\..\\c\\", "C:\\c";    "absolute double dot 16"))]
    ...
    #[test_case(make_non_utf8_os_string(), Err(EK::InputNotUtf8); "non utf-8")]
    ...
    fn fmt_working_dir(template: &str, working_dir: &Path) -> String {
        template.replace("{work}", working_dir.to_str().unwrap())
    }
}
