...
mod tests {
    ...
    mod parse {
        ...
        #[test_case("",         EK::ExpectedFilter,                0..0; "empty")]
        #[test_case("-",        EK::UnknownFilter(Char::Raw('-')), 0..1; "unknown")]
        #[test_case("#",        EK::ExpectedRange,                 1..1; "substring expected range")]
        #[test_case("#-",       EK::ExpectedRange,                 2..2; "substring rev expected range")]
        #[test_case("&",        EK::ExpectedNumber,                1..1; "column expected number")]
        #[test_case("&-",       EK::ExpectedNumber,                2..2; "column rev expected number")]
        #[test_case("&1:",      EK::ExpectedColumnSeparator,       3..3; "column expected separator")]
        #[test_case("&-1:",     EK::ExpectedColumnSeparator,       4..4; "column rev expected separator")]
        #[test_case("&1/[0-9",  EK::RegexInvalid(AS::any()),       3..7; "column regex invalid")]
        #[test_case("&-1/[0-9", EK::RegexInvalid(AS::any()),       4..8; "column rev regex invalid")]
        #[test_case("r",        EK::ExpectedSubstitution,          1..1; "replace expected substitution")]
        #[test_case("R",        EK::ExpectedSubstitution,          1..1; "replace all expected substitution")]
        #[test_case("=",        EK::ExpectedRegex,                 1..1; "regex match expected regex")]
        #[test_case("=[0",      EK::RegexInvalid(AS::any()),       1..3; "regex match invalid regex")]
        #[test_case("s",        EK::ExpectedSubstitution,          1..1; "regex replace expected substitution")]
        #[test_case("s/[0/",    EK::RegexInvalid(AS::any()),       2..4; "regex replace invalid regex")]
        #[test_case("S",        EK::ExpectedSubstitution,          1..1; "regex replace all expected substitution")]
        #[test_case("S/[0/",    EK::RegexInvalid(AS::any()),       2..4; "regex replace all invalid regex")]
        #[test_case("@:[0:X:Y", EK::RegexInvalid(AS::any()),       2..4; "regex switch invalid regex")]
        #[test_case("$",        EK::ExpectedNumber,                1..1; "regex capture expected number")]
        #[test_case("<x",       EK::PaddingPrefixInvalid('<', Some(Char::Raw('x'))), 1..2; "padding left prefix invalid")]
        #[test_case(">y",       EK::PaddingPrefixInvalid('>', Some(Char::Raw('y'))), 1..2; "padding right prefix invalid")]
        fn err(input: &str, kind: EK, range: ByteRange) {
            assert_eq!(
    ...
    mod eval {
        ...
        #[test_case("non-existent", F::CanonicalPath, EK::CanonicalizationFailed(AS::any()); "canonicalization failed")]
