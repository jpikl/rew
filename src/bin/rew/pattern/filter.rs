...
mod tests {
    ...
    mod eval {
        ...
        #[cfg_attr(windows, test_case("C:\\parent\\file.ext", Filter::RelativePath, "..\\parent\\file.ext"; "relative path"))]
        #[cfg_attr(windows, test_case("root\\parent\\..\\new-parent\\.\\dir\\", Filter::NormalizedPath, "root\\new-parent\\dir"; "normalized path"))]
        ...
        #[cfg_attr(unix, test_case("root/parent", Filter::EnsureTrailingDirSeparator, "root/parent/"; "ensure trailing separator"))]
        #[cfg_attr(windows, test_case("root\\parent", Filter::EnsureTrailingDirSeparator, "root\\parent\\"; "ensure trailing separator"))]
