...
pub fn copy_lines(reader: &mut Reader<impl Read>, writer: &mut Writer<impl Write>) -> Result<()> {
...
pub fn copy_blocks(reader: &mut Reader<impl Read>, writer: &mut Writer<impl Write>) -> Result<()> {
