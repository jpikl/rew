...
command_test!("cat", {
    ...
    // seq 1 10000 | cksum
    default_big: [ sh "seq 1 10000 | %cmd% | cksum" assert "" => "1588019829 48894\n" ],
    ...
    // seq 1 10000 | cksum
    bytes_big: [ sh "seq 1 10000 | %cmd% -b | cksum" assert "" => "1588019829 48894\n" ],
    ...
    // seq 1 10000 | cksum
    chars_big: [ sh "seq 1 10000 | %cmd% -c | cksum" assert "" => "1588019829 48894\n" ],
    ...
    // seq 1 10000 | cksum
    lines_big: [ sh "seq 1 10000 | %cmd% -l | cksum" assert "" => "1588019829 48894\n" ],
    ...
    // seq 1 10000 | tr '\n' '\0' | cksum
    records_big: [ sh "seq 1 10000 | tr '\\n' '\\0' | %cmd% -l0 | cksum" assert "" => "3754827107 48894\n" ],
});
