...
command_test!("cat", {
    ...
    chunks_empty: [ cmd "-c" should "" => "" ],
    chunks_items: [ cmd "-c" should "a\nbc\r\ndef\0ghij" => "a\nbc\r\ndef\0ghij" ],
    chunks_buf_mode: [ cmd "-c" "--buf-mode=line" should "a\nbc\r\ndef\0ghij" => "a\nbc\r\ndef\0ghij" ],
    chunks_buf_size: [ cmd "-c" "--buf-size=8" should "123456789" => "123456789" ],
    chunks_non_utf8: [ cmd "-c" should &[0x00, 0x9f, 0x92, 0x96] => vec![0x00, 0x9f, 0x92, 0x96] ],
    // seq 1 10000 | md5sum
    chunks_big: [ sh "seq 1 10000 | %cmd% -c | md5sum" should "" => "72d4ff27a28afbc066d5804999d5a504  -\n" ],
