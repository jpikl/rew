...
Let's start with output of the POSIX `find` command:
...
Or into a tool like [GNU parallel](https://www.gnu.org/software/parallel/parallel.html) for parallel execution:
...
Here is how you setup development environment:

1. Install [rustup](https://www.rust-lang.org/tools/install) (toolchain manager).
2. Install [just](https://github.com/casey/just) (taks runner).
3. Install [cargo-binstall](https://github.com/cargo-bins/cargo-binstall) (binaries installer).
4. Run `just setup` to install additional binary dependencies.
5. Run `just` to see available recipes.
